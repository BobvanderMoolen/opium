...
async function nftDropKeypom(){
	...
	const credentialsPath =  path.join(homedir, CREDENTIALS_DIR);
        const YOUR_ACCOUNT = "geronimogeoemon.testnet";
        const NFT_TOKEN_ID = "pixel-token-blue";
        const NFT_CONTRACT = "gradonsky.testnet";
	...
	await fundingAccount.functionCall({
		...
		args: {
			...
			metadata: {
			    title: "Pixel Bonanza",
			    description: "Your Pixel!",
			    media: "https://ipfs.io/ipfs/QmVktvAB3YrwoMGbMB7PoZAz4twpeokFPvhqqBL35W6USg/blue.png",
