...
export class Contract extends NearContract {
    ...
    maxPlayers: Number;
    playersGroups: Number;
    pixelsPerPlayer: Number;
    ...
    */
    ...
    @call
    setupGame({maxPlayers, pixelsPerPlayer}) {
        this.maxPlayers = maxPlayers;
        this.pixelsPerPlayer = pixelsPerPlayer;
    }

    @call
    paint({_x,_y,_z}) {
        let playerCall = near.predecessorAccountId();
        const _pixel: Location = {x: _x, y: _y, z: _z};
        // tutaj podac 
        const length = Object.keys(this.players[playerCall].pixellocation).length;
        this.players[playerCall].pixellocation[length] = _pixel;
        this.players[playerCall].isPlaced = true;
        //burn
    ...
    */
    ...
    nft_mint({ token_id, metadata, receiver_id, perpetual_royalties }) {
       // assert(this.tokenCounter < maximal_minting, "Maximum number of players reached");
